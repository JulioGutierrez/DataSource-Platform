<?php
    ...
    class EngineMYSQL extends AbstractEngineSQL implements IEngineSQL {
        ...
        public function select($query) {
            try{
                return json_encode($this->createCommand(str_replace('"','',$query)));
            } catch (Exception $ex) {
                throw new Exception($ex->getMessage());
            }
        }
        ...
        {
            try { 
                $dsn="mysql:host=".$this->configuration->getServerData()->getIp().";".
